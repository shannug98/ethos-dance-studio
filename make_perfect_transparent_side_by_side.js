...
fs.createReadStream(logoPath)
  ...
  .on('parsed', function() {
    ...
    // Crop Symbol (upper ~64% of height)
    ...
    for (let y = 0; y < symH; y++) {
      for (let x = 0; x < symW; x++) {
        ...
        // Background is light (r>100, g>100, b>100) -> MAKE TRANSPARENT!
    ...
    console.log('✓ Created perfect side-by-side logo PNG with 0% white background block!');
  });
